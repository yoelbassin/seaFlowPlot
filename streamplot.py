...
def streamplot(axes, x, y, u, v, density=1, linewidth=None, color=None,
               ...
               maxlength=4.0, integration_direction='both', res=1):
    """
...
def _get_integrator(u, v, dmap, minlength, maxlength, integration_direction):
    ...
    def integrate(x0, y0, res):
        ...
        if integration_direction in ['both', 'backward']:
            s, xyt = _integrate_rk12(x0, y0, dmap, backward_time, maxlength, res)
            stotal += s
            xy_traj += xyt[::-1]

        if integration_direction in ['both', 'forward']:
            dmap.reset_start_point(x0, y0)
            s, xyt = _integrate_rk12(x0, y0, dmap, forward_time, maxlength, res)
            stotal += s
            xy_traj += xyt[1:]
...
def _integrate_rk12(x0, y0, dmap, f, maxlength, res):
    """
    ...
    maxds = res * min(1. / dmap.mask.nx, 1. / dmap.mask.ny, 0.1)
